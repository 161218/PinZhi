...
- (void)layoutSubviews
{
    ...
    // 1.箭头
    self.statusLabel.frame=CGRectMake([[UIScreen mainScreen] applicationFrame].size.width/2-90, [[UIScreen mainScreen] applicationFrame].size.width/2 -130, self.mj_width * 0.5, 40);
}
...
- (void)adjustFrameWithContentSize
{
    ...
    // 设置位置和尺寸
    self.mj_y = MAX(contentHeight, scrollHeight-44);
}
...
- (CGFloat)heightForContentBreakView
{
    ...
    return self.scrollView.contentSize.height - h-80;
}
