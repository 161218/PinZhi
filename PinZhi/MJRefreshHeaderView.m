...
- (void)layoutSubviews
{
    ...
    // 1.状态标签
    self.statusLabel.frame = CGRectMake(statusX, statusY+44, statusWidth, statusHeight);
    ...
    self.lastUpdateTimeLabel.frame = CGRectMake(lastUpdateX, lastUpdateY+44, lastUpdateWidth, lastUpdateHeight);
}
