...
- (void)layoutSubviews
{
    ...
    self.arrowImage.center = CGPointMake(arrowX, self.mj_height);
    
//    if (IOS7) {
//        
//        self.arrowImage.frame= CGRectMake([[UIScreen mainScreen] applicationFrame].size.width/2-100, [[UIScreen mainScreen] applicationFrame].size.width/2 -150,10, 40);
//    }else{
//        
//        self.arrowImage.frame= CGRectMake([[UIScreen mainScreen] applicationFrame].size.width/2-100, [[UIScreen mainScreen] applicationFrame].size.width/2 -120,10, 40);
